...
public class JobPostController {
	...
	private JobPostService jobPostService;
	 ...
	 @Authorize
	    ...
	    @Authorize
	    public  ApiResponse getApplicants(@PathVariable("username") String username,@RequestParam Long jobId,@RequestParam String status,HttpServletRequest httpRequest ) throws UnauthorizedException {
			Utils.matchString(httpRequest.getAttribute("username").toString(), username);
