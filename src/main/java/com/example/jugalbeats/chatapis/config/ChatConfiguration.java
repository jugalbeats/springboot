package com.example.jugalbeats.chatapis.config;
...
import com.example.jugalbeats.chatapis.client.ChatClient;
...
public class ChatConfiguration {
	...
	@Bean
	public ChatClient fcsClient(@Value("${connection.read.timeout.second:60}") final Long timeoutSeconds,
			@Value("${chat.base.url}") final String baseUrl) {
		return new Retrofit.Builder()
				...
				.addCallAdapterFactory(RxJava2CallAdapterFactory.create()).build().create(ChatClient.class);
	}
